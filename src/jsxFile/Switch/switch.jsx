...
import "../../cssFile/switch-css/switch.css"
...
const getUsers = () => {
    try {
        ...
        console.error("Error parsing users from cookies", error);
        return [];
    }
};
...
export default function Switch({ setResponseMessage }) {
    ...
    const handleSubmit = async (username, password) => {
        ...
        try {
            ...
            if (response.data.message === "Password or username is incorrect") {
