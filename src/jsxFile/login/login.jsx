...
export default function Login({ setResponseMessage }) {
    const alluser = getUsers()

    return (
        <div className="outloginm">
            <div className="login">
                ...
                <div className="inlogin">
                    ...
                    <div className="outbox">
                        ...
                        <a className="forgot" href="./forgot/login">Forgot your password ?</a>
                        {alluser.length > 0 && <a className="newuser" href="./Switch">Login existing account. </a>}
                        <a className="newuser" href="./creating"> Create a new Account</a>
                    </div>
